...
// Las variables $titulo_pagina, $secciones y $niveles
...
<div class="dashboard-header">
    <div>
        ...
        <p style="text-align: left; margin: 0;">Llena los campos para registrar un nuevo archivo.</p>
    </div>
    <a href="/LIBRERIAKONOHA/documentos" class="btn" style="width: auto; background-color: #e5e5e7; color: #333;">Cancelar y Volver</a>
</div>

<form action="/LIBRERIAKONOHA/documentos/crear" method="POST">
    ...
    <div style="display: flex; gap: 20px;">
        ...
        <div class="form-group" style="flex: 1;">
            ...
            <input type="text" id="tipo" name="tipo" class="form-control" placeholder="Ej: Pergamino" required>
        </div>
    </div>

    <div style="display: flex; gap: 20px;">
        <div class="form-group" style="flex: 1;">
            <label for="id_seccion" class="form-label">Sección (Req: "secciones")</label>
    ...
    <div style="display: flex; gap: 20px;">
        ...
        <div class="form-group" style="flex: 1; display: flex; align-items: center; padding-top: 20px;">
             <input type="checkbox" id="acceso_restringido" name="acceso_restringido" value="1" style="width: 20px; height: 20px; margin-right: 10px;">
    ...
    <div class="form-group" style="margin-top: 20px; border-top: 1px solid #e5e5e7; padding-top: 20px;">
        <button type="submit" class="btn btn-primary">Guardar Nuevo Documento</button>
    </div>
</form>
